...
const Banner = () => {
  ...
  <div class="card-body ">
    ...
    <p className='text-xl w-4/5 md:w-2/3 my-5 mx-auto'>Here you can buy or sell Desktop Parts so easily. <br /> And we provide 100% authentication of the products. <br /> The most trusted company in bangladesh.</p>
    </div>
  </div>
</div>
    );
